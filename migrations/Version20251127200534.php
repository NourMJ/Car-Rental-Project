 ...
 */
final class Version20251127200534 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voiture ADD modele_id INT DEFAULT NULL, DROP modele');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE voiture ADD modele VARCHAR(255) NOT NULL, DROP modele_id');
    }
}
